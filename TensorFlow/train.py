...
#10% of the data will used for validation
validation_size = 0.1
#image pixel size
img_size = 150
num_channels = 3
...
def create_convolutional_layer(input,
    ...
    #Using max-pooling sample-based discretization process.  
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0: 
            ...
            #For windows we have to define the whole path where the saved model will be stored.
            saver.save(session, 'C:\\Users\\niyaz\\Desktop\\CSE299\\cv-tricks.com\\Tensorflow-tutorials\\tutorial-2-image-classifier\\Numbers-model') 
